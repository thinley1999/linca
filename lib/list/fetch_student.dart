...
class FetchStudent extends StatefulWidget {
  ...
  const FetchStudent({Key key, this.s_list, this.index}) : super(key: key);
...
class _FetchStudentState extends State<FetchStudent> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<QuerySnapshot>(
        future: FirebaseFirestore.instance.collection("CollegeStudent").where("UID",isEqualTo: widget.s_list[widget.index]["UID"].toString()).get(),
                                                                    ...
                                                                    child: FlatButton(
                                                                      onPressed: () async {
                                                                        Map <String, dynamic> data = {
                                                                          ...
                                                                          "Description": studentController.text,
