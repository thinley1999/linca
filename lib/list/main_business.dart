...
class MainBusiness extends StatelessWidget {
  final List<DocumentSnapshot> b_list;
  final int index;

   MainBusiness({Key key, this.b_list, this.index}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<QuerySnapshot>(
        future: FirebaseFirestore.instance.collection("Business").where("UID",isEqualTo: b_list[index]["UID"].toString()).get(),
                    ...
                    child: Row(
                      children: [
                        ...
                        ButtonTheme(
                          ...
                          child: FlatButton(
                              onPressed: () async {
                                Navigator.pushNamed(context, '/press_business');
                                Map <String, dynamic> data = {
                                  "UID": document["UID"],
                                };
                                await FirebaseFirestore.instance.collection("User").doc(( _auth.currentUser).uid).collection("BusiList").doc(( _auth.currentUser).uid).set(data);
                              },
                              child: Column(
                                children: [
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              SizedBox(height: 5,),
                                              Text(
                                                "Are you sure that you want to delete " + document["Name"] + " business card",
