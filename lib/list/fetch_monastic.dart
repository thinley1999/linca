...
class FetchMonastic extends StatefulWidget {
  final List<DocumentSnapshot> m_list;
  final int index;

  const FetchMonastic({Key key, this.m_list, this.index}) : super(key: key);

  @override
  _FetchMonasticState createState() => _FetchMonasticState();
}

class _FetchMonasticState extends State<FetchMonastic> {
  final FirebaseAuth _auth = FirebaseAuth.instance;
  Future<String> getCurrentUID() async{
    return (await _auth.currentUser).uid;
  }
  TextEditingController monasticController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<QuerySnapshot>(
        future: FirebaseFirestore.instance.collection("Monastic").where("UID",isEqualTo: widget.m_list[widget.index]["UID"].toString()).get(),
                                                                    ...
                                                                    child: FlatButton(
                                                                      onPressed: () async {
                                                                        Map <String, dynamic> data = {
                                                                          ...
                                                                          "Description": monasticController.text,
