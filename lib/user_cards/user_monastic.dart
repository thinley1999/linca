...
class UserMonastic extends StatefulWidget {
  @override
  _UserMonasticState createState() => _UserMonasticState();
}

class _UserMonasticState extends State<UserMonastic> {
  var db;
  void initState() {
    db = FirebaseFirestore.instance.collection("Monastic").doc("Mona" + (_auth.currentUser).uid).snapshots();
    super.initState();
  }
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            SizedBox(height: 5,),
                                                            Text(
                                                              "Are you sure that you want to delete your monastic card.",
                                                              style: GoogleFonts.ptSerif(fontSize: 20,),
                                                              textAlign: TextAlign.center,
                                                            ),
                                                            SizedBox(height: 20,),
                                                            Row(
                                                              ...
                                                              children: [
                                                                WillPopScope(
                                                                  ...
                                                                  child: FlatButton(
                                                                    onPressed: () async{
                                                                      await FirebaseFirestore.instance.collection("Monastic").doc("Mona" + (_auth.currentUser).uid).delete();
