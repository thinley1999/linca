...
class FetchBusiness extends StatefulWidget {
  final List<DocumentSnapshot> b_list;
  final int index;

  const FetchBusiness({Key key, this.b_list, this.index}) : super(key: key);
  @override
  _FetchBusinessState createState() => _FetchBusinessState();
}

class _FetchBusinessState extends State<FetchBusiness> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<QuerySnapshot>(
        future: FirebaseFirestore.instance.collection("Business").where("UID",isEqualTo: widget.b_list[widget.index]["UID"].toString()).get(),
