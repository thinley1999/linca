...
class CollegeStudentQr extends StatefulWidget {
  @override
  _CollegeStudentQrState createState() => _CollegeStudentQrState();
}

class _CollegeStudentQrState extends State<CollegeStudentQr> {
