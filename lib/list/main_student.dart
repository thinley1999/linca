...
class MainStudent extends StatelessWidget {
  ...
  MainStudent({Key key, this.s_list, this.index}) : super(key: key);
                    ...
                    child: Row(
                      children: [
                        ...
                        ButtonTheme(
                          ...
                          child: FlatButton(
                              onPressed: () async {
                                Navigator.pushNamed(context, '/press_student');
                                Map <String, dynamic> data = {
                                  "UID": document["UID"],
                                };
                                await FirebaseFirestore.instance.collection("User").doc(( _auth.currentUser).uid).collection("CollList").doc(( _auth.currentUser).uid).set(data);
                              },
                              child: Column(
                                children: [
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              SizedBox(height: 5,),
                                              Text(
                                                "Are you sure that you want to delete " + document["Name"] + " student card",
