...
class UserCivilServant extends StatefulWidget {
  @override
  _UserCivilServantState createState() => _UserCivilServantState();
}

class _UserCivilServantState extends State<UserCivilServant> {
  var db;
  void initState() {
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 20,),
                                          new Text(
                                            userDocument["Organization Name"],
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 20,),
                                          new Text(
                                            userDocument["Organization address"],
                                            style: GoogleFonts.ptSerif(fontSize: 20),
                                          ),
                                        ],
                                      ),
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            SizedBox(height: 5,),
                                                            Text(
                                                              "Are you sure that you want to delete your civil servant card.",
                                                              style: GoogleFonts.ptSerif(fontSize: 20,),
                                                              textAlign: TextAlign.center,
                                                            ),
                                                            SizedBox(height: 20,),
                                                            Row(
                                                              ...
                                                              children: [
                                                                WillPopScope(
                                                                  ...
                                                                  child: FlatButton(
                                                                    onPressed: () async{
                                                                      await FirebaseFirestore.instance.collection("CivilServant").doc("Civi" + (_auth.currentUser).uid).delete();
