...
class UserCollegeStudent extends StatefulWidget {
  @override
  _UserCollegeStudentState createState() => _UserCollegeStudentState();
}

class _UserCollegeStudentState extends State<UserCollegeStudent> {
  var db;
  void initState() {
    db = FirebaseFirestore.instance.collection("CollegeStudent").doc("Coll" + (_auth.currentUser).uid).snapshots();
    super.initState();
  }
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            SizedBox(height: 5,),
                                                            Text(
                                                              "Are you sure that you want to delete your student card.",
                                                              style: GoogleFonts.ptSerif(fontSize: 20,),
                                                              textAlign: TextAlign.center,
                                                            ),
                                                            SizedBox(height: 20,),
                                                            Row(
                                                              ...
                                                              children: [
                                                                WillPopScope(
                                                                  ...
                                                                  child: FlatButton(
                                                                    onPressed: () async{
                                                                      await FirebaseFirestore.instance.collection("CollegeStudent").doc("Coll" + (_auth.currentUser).uid).delete();
